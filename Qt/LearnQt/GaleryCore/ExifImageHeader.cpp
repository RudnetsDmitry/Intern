...
/*!
	...
	*/
QPixmap QExifImageHeader::thumbnailPixmap(QString const& filePath)
{
	QPixmap pixmap(filePath);
	
	if (d->thumbnailOrientation.isNull() || pixmap.isNull())
		return pixmap;
	...
	case 1:
		return pixmap;
	case 2:
		return pixmap.transformed(QTransform().rotate(180, Qt::YAxis));
	case 3:
		return pixmap.transformed(QTransform().rotate(180, Qt::ZAxis));
	case 4:
		return pixmap.transformed(QTransform().rotate(180, Qt::XAxis));
	case 5:
		return pixmap.transformed(QTransform().rotate(180, Qt::YAxis).rotate(90, Qt::ZAxis));
	case 6:
		return pixmap.transformed(QTransform().rotate(90, Qt::ZAxis));
	case 7:
		return pixmap.transformed(QTransform().rotate(180, Qt::XAxis).rotate(90, Qt::ZAxis));
	case 8:
		return pixmap.transformed(QTransform().rotate(270, Qt::ZAxis));
	default:
		return pixmap;
	}
}
