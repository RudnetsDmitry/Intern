/// @file	ShaderUtilsVSG.cpp
///
/// @see	ShaderUtilsVSG.h
///
/// @author	RDN © Intern :)
///
/// @date    28.02.2026 10:50
///

#include "stdafx.h"
#include "ShaderUtilsVSG.h"
...
namespace vsg3d
{
	...
	vsg::ref_ptr<vsg::ShaderSet> createLineShaderSet(bool skipZbuffer)
	{
		// vsg::info("Local LineShaderSet(", options, ")");

		auto vertexShader = vsg::ShaderStage::create(VK_SHADER_STAGE_VERTEX_BIT, "main", lineVERT);
		auto fragmentShader = vsg::ShaderStage::create(VK_SHADER_STAGE_FRAGMENT_BIT, "main", lineFRAG);
...
//		auto vertexShader = vsg::ShaderStage::create(VK_SHADER_STAGE_VERTEX_BIT, "main", vsg3d::pbrVERT);
//		auto fragmentShader = vsg::ShaderStage::create(VK_SHADER_STAGE_FRAGMENT_BIT, "main", vsg3d::pbrFRAG);
//
//		if (!vertexShader || !fragmentShader) 
//		{
...
//	}
														...
														std::optional<LineStippleInfo> lineStipple)
	{
		...
		vsg::ref_ptr<vsg::ShaderSet> activeShaderSet = createLineShaderSet(skipZbuffer);
